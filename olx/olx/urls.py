...
from api.views import ProductsView,ProductDetailsView,ReviewDetailsView,ReviewView,ProductsViewsetView,ProductModelviewsetview,ReviewModelViewsetView,UserView
from rest_framework_simplejwt.views import TokenRefreshView,TokenObtainPairView
router=DefaultRouter()
router.register("api/v1/products",ProductsViewsetView,basename="products")
router.register("api/v2/products",ProductModelviewsetview,basename="bikes")
